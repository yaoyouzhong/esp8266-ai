...
| | **自动屏保与 Codex 提醒**<br>Windows 可按真实键鼠空闲时间在 1/5/10/30/60 分钟后进入移动时钟屏保；键鼠恢复后回到原页面。立即预览不会被正在工作的桌宠覆盖。Codex 等待审批时全局切入红色边框提醒；一个或多个任务完成时 Windows 播放专属四音上行提示音，屏幕显示 5 次平滑绿色脉冲和桌宠庆祝动作，随后恢复原页面。 |
